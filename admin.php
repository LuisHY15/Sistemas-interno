...
if ( isset($_GET['m']) ){
    switch($_GET['m']) {
        ...
        /* clientes */
         /* reportes */
        //este primer case es para el reporte de Martin
        /*case "reportes":
...
<!-- Agregar condicion en base a privilegios -->
                ...
                <li>
                    ...
                    <ul class="nav nav-second-level sidebar-collapse">
                        <li>
                            <a href="admin.php?m=reportes"><i class=""><span class="nav-label">Reporte de Pedimentos</span> </i></a>
                        </li>
                        <li>
                            <a href="admin.php?m=reportePedCon"><i class=""><span class="nav-label">Reporte de Pedimentos Consolidados</span> </i></a>
                        </li>
                    </ul>
                </li>
                <li>
        ...
        <div class="footer">
            <div>
                <strong>Copyright</strong> Tramitaciones de comercio Intercontinental, S.C. 2017 
            </div>
        </div>
