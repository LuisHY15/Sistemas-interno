<?php
		...
		FROM AT001 
		WHERE  C001CVECLI = '".$NoCliente."' AND C001TIPOPE=".$tipop."  AND C001ADUSEC='".$Aduana."' AND  D001FECPAG BETWEEN '".$fechaInicial."' AND '".$fechaFinal."' ".$cveQuery." ORDER BY(D001FECPAG)";
